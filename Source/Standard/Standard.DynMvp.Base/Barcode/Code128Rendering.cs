...
namespace Standard.DynMvp.Base.Barcode
{
    ...
    /// </summary>
    public class Code128Renderer : BarcodeRenderer
    {
        ...
        private int barWeight = 1;
        public int BarWeight
        {
            get { return barWeight; }
            set { barWeight = value; }
        }

        private bool addQuietZone = true;
        public bool AddQuietZone
        {
            get { return addQuietZone; }
            set { addQuietZone = value; }
        }

...
namespace Standard.DynMvp.Vision
{
    ...
    public abstract class ImageProcessing
    {
        ...
        public double Binarize(AlgoImage algoImage, bool inverse = false)
        {
            return Binarize(algoImage, algoImage, inverse);
        }
        ...
        {
            Dilate(algoImage, algoImage, kernelSize, numDilate);
        }
        ...
        // Auto Threshold
        public abstract double Binarize(AlgoImage srcImage, AlgoImage destImage, bool inverse = false);

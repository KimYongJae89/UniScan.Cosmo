...
//            foreach (Axis axis in axisList)
//                moveOn[axis.AxisNo] = axis.IsMoveOn();
...
//                    //ErrorSection.Motion.ToString(), MotionError.Moving.ToString(), String.Format("Han0dler {0}", this.name));
//                    return false;
//                }
//            }
...
//            return axisPosition;//RobotAligner.InverseAlign(axisPosition);
//        }
...
//            for (int index = 0; index < axisPosition.NumAxis && index < axisList.Count; index++)
//            {
//                string axisName = uniqueAxisList[index].Name;
//                SetPosition(axisName, axisPosition[index]);
//            }
//        }
...
//            return maxVelocityAxis.StartMultiMove(axisPosition.Position, movingParam); ;
//        }

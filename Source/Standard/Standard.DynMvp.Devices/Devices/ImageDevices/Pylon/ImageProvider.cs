...
//namespace Standard.DynMvp.Devices.ImageDevices.Pylon
//{
...
//            m_hStop = Pylon.WaitObjectCreate();
//        }
...
//            {
//                Pylon.WaitObjectSignal(m_hStop);                
...
//                PYLON_WAITOBJECTS_HANDLE waitObjects = Pylon.WaitObjectsCreate();
//                Pylon.WaitObjectsAdd(waitObjects, m_hWait);
//                Pylon.WaitObjectsAdd(waitObjects, m_hStop);
...
//                    uint index = 0;
//                    if (!Pylon.WaitObjectsWaitForAny(waitObjects, 20000, out index))
//                    {
//                        lock (m_lockObject)
//                        {

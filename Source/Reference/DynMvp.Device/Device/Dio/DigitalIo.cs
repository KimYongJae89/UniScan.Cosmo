...
namespace DynMvp.Devices.Dio
{
    public enum DigitalIoType
    {
        ...
        Modubus, ComizoaSd424f, TmcAexxx, NIMax, Ajin, KM6050, AlphaMotionBx, AlphaMotionBBx
    }
    ...
    public interface IDigitalIo
    {
        ...
        uint ReadOutputGroup(int groupNo, int portNo);
        uint ReadInputGroup(int groupNo, int portNo);
    ...
    public abstract class DigitalIo : Device, IDigitalIo
    {
        ...
        public abstract uint ReadOutputGroup(int groupNo, int portNo);
        public abstract uint ReadInputGroup(int groupNo, int portNo);

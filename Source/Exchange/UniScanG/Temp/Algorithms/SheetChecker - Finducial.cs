...
//{
//    internal class FiducialFinder : SheetCheckerStep
//    {
//        private const int fiducialMargine = 20;
//        private const int fiducialSobelSize = 3;

//        PatternMatchingParam patternMatchingParam = null;
//        Pattern pattern = null;


//        public FiducialFinder(AlgorithmParam sheetCheckerFiducial)
//        {
//            this.AlgorithmName = "SheetCheckerFiducial";

//            this.param = sheetCheckerFiducial;

//            patternMatchingParam = new PatternMatchingParam();
//            patternMatchingParam.UseWholeImage = true;
//            patternMatchingParam.NumToFind = 0;
//            patternMatchingParam.MaxAngle = patternMatchingParam.MinAngle = 0;

//            SheetCheckerParam param = (SheetCheckerParam)sheetCheckerFiducial;
//            if (param.FiducialFinderParam.FiducialPatternEdgeImage != null)
//                this.Train(param.FiducialFinderParam.FiducialPatternEdgeImage);
//        }
...
//            Size fidSize = new Size(fiducialFinderParam.FidSizeWidth, fiducialFinderParam.FidSizeHeight);
//            SizeF FidSearchBound = new SizeF(fiducialFinderParam.FidSearchLBound, fiducialFinderParam.FidSearchRBound);

//            FiducialFinderInspectParam fiducialParam = algorithmInspectParam as FiducialFinderInspectParam;
//            AlgoImage baseImage = fiducialParam.FrameImage;
//            bool saveImage = ((UniScanGSettings.Instance().SaveFiducialDebugData & SaveDebugData.Image) > 0);
//            DebugContext debugContext = new DebugContext(saveImage, Path.Combine(fiducialParam.DebugContext.Path, "FiducialFinder"));
//            bool updatePatternImage = fiducialParam.UpdatePatternImage;
...
//        public void Train(Image2D patternImageD)
//        {
...
//        //private void UpdateFiducialImage(AlgoImage algoImage, Rectangle rectangle, DebugContext debugContext)
//        //{
//        //    //rectangle.Inflate(fiducialMargine, fiducialMargine);
//        //    rectangle.Intersect(new Rectangle(0, 0, algoImage.Width, algoImage.Height));
//        //    AlgoImage clipImage = algoImage.Clip(rectangle);
//        //    ImageProcessing imageProcessing = AlgorithmBuilder.GetImageProcessing(clipImage);
//        //    imageProcessing.Average(clipImage);
//        //    imageProcessing.Sobel(clipImage, fiducialSobelSize);
//        //    //imageProcessing.Binarize(clipImage, fiducialBin);
//        //    (this.param as SheetCheckerFiducialParam).FiducialPatternEdgeImage = clipImage.ToImageD();
//        //    clipImage.Save("NewPattern.bmp", debugContext);

...
namespace UniScanG.UI.ModelPage
{
    ...
    internal partial class ModelForm : Form, IMultiLanguageSupport
    {
        ...
        ModelDescriptionG modelDescription = null;
        public ModelDescriptionG ModelDescription
        {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            switch (modelFormType)
            {
                case ModelFormType.New:
                    ...
                    modelDescription = (ModelDescriptionG)SystemManager.Instance().ModelManager.CreateModelDescription();
                    GetModelData();
                    break;

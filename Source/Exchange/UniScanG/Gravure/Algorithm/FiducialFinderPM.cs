...
{
    public class FiducialFinderPMParam : DynMvp.Vision.AlgorithmParam
    {
    ...
    public class FiducialFinderPMResult : DynMvp.Vision.AlgorithmResult
    {

    }

    public class FiducialFinderPM : DynMvp.Vision.Algorithm
    {

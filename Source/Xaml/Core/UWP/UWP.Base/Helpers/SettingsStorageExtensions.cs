...
namespace UWP.Base.Helpers
{
    ...
    public static class SettingsStorageExtensions
    {
        ...
        public static async Task<T> ReadAsync<T>(this StorageFolder folder, string name, params JsonConverter[] converters)
        {
        ...
        public static async Task<T> ReadAsync<T>(this ApplicationDataContainer settings, string key, params JsonConverter[] converters)
        {
            object obj = null;

            if (settings.Values.TryGetValue(key, out obj))
            {
                return await Json.ToObjectAsync<T>((string)obj, converters);
            }
